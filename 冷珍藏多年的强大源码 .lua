...
local UITab79 = window:Tab("冷汉化阿尔宙斯脚本",'17860099393')

local about = UITab79:section("『LENG Script』",true)
...
local UITab79 = win:Tab("音乐🎵",'7734068321')

local about = UITab79:section("『音乐』",true)

about:Button("国歌",function()
...
local UITab80 = win:Tab("挖到中国",'7734068321')
